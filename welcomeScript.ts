export const welcomeScript =
  ...
  'Follow these steps:\n\n' +
  '1. Enter the session name in the upper left corner.\n' +
  ...
  '4. To add a command to the pane, just type it inside the pane. You can add more commands or delete commands by pressing the buttons on the right.\n' +
